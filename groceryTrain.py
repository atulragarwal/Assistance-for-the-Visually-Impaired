...
completePath = "GroceryStoreDataset-master\dataset\Train\Fruit\Image"
...
dataset = CustomImageDataset(annotations_file = "groceryLabel.csv", img_dir = completePath, transform = transforms.ToTensor())
# transform = transforms.ToTensor()

print(len(dataset))

trainSet, testSet = torch.utils.data.random_split(dataset, [500, 23])
...
torch.save(net, "groceryModel.pth")
