...
dataset = CustomImageDataset(annotations_file = "labelsNew.csv", img_dir = completePath, transform = transforms.ToTensor())
# transform = transforms.ToTensor()

# print(len(dataset))
trainSet, testSet = torch.utils.data.random_split(dataset, [1850, 108])
