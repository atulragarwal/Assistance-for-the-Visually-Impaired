...
completePath = "visuallyimpair\Resize_dataset"
...
dataset = CustomImageDataset(annotations_file = "obstaclesLabel.csv", img_dir = completePath, transform = transforms.ToTensor())
# transform = transforms.ToTensor()

print(len(dataset))

trainSet, testSet = torch.utils.data.random_split(dataset, [700, 39])
...
torch.save(net, "obstacleModel.pth")
